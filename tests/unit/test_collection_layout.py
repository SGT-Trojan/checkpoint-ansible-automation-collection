...
class CollectionLayoutTests(unittest.TestCase):
    ...
    def test_required_public_documents_exist(self) -> None:
        for relative in (
            ...
            "roles/checkpoint_deployment_agent_artifact_staging/defaults/main.yml",
            "roles/checkpoint_deployment_agent_artifact_staging/tasks/main.yml",
            ...
            "tests/integration/deployment_agent_artifact_staging_syntax.yml",
            ...
            "plugins/modules/cp_automation_deployment_agent_artifact_stage.py",
            ...
            "plugins/module_utils/deployment_agent_artifact_staging.py",
            ...
            "tests/unit/plugins/module_utils/test_deployment_agent_artifact_staging.py",
            ...
            "tests/unit/plugins/modules/test_deployment_agent_artifact_stage_module.py",
            ...
            "tests/unit/test_deployment_agent_artifact_staging_role.py",
